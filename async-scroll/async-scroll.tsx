...
// };
// // todo file not used;
// export default class AsyncScroll extends React.Component<any, any> {
...
//         );
//
//         const visibleHeight = parseFloat(window.getComputedStyle(this.getWrapper(), null).getPropertyValue('height'));
//
...
//
//     getDefaultHeightWidth = () => (this.props.className ? {} : { height: '100%', width: '100%' });
//
...
//                 this.getScrollPosition() + this.state.visibleHeight + this.props.overScanCount * this.props.rowHeight
//         );
//     };
//
//     renderList = () => (
